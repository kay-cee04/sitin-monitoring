...
.entries-wrap select{padding:5px 10px;border:1px solid var(--gray-200);border-radius:var(--radius);font-family:'Inter',sans-serif;font-size:13px;color:var(--gray-800);background:var(--white);outline:none;}
...
.search-wrap input{padding:7px 12px;border:1px solid var(--gray-200);border-radius:var(--radius);font-family:'Inter',sans-serif;font-size:13px;color:var(--gray-800);outline:none;width:200px;}
.search-wrap input:focus{border-color:var(--blue);box-shadow:0 0 0 3px rgba(27,88,134,0.10);}

.table-card{background:var(--white);border-radius:var(--radius);border:1px solid var(--gray-200);box-shadow:var(--shadow);overflow:hidden;}
...
thead th .sort{font-size:10px;opacity:0.7;margin-left:4px;}
...
.no-data{text-align:center;padding:32px;color:var(--gray-400);font-size:13px;font-style:italic;}

.table-footer{
  display:flex;align-items:center;justify-content:space-between;
  padding:12px 16px;border-top:1px solid var(--gray-100);
  font-size:12.5px;color:var(--gray-400);flex-wrap:wrap;gap:8px;
}
.pagination{display:flex;align-items:center;gap:4px;}
.page-btn{
  width:30px;height:30px;border-radius:6px;
  border:1px solid var(--gray-200);background:var(--white);
  font-size:12px;font-family:'Inter',sans-serif;color:var(--gray-600);
...
<div class="page-body">
  ...
  <div class="table-card">
    <table>
      <thead>
        <tr>
          <th>ID Number <span class="sort">⇅</span></th>
          <th>Name <span class="sort">⇅</span></th>
          <th>Sit Purpose <span class="sort">⇅</span></th>
          <th>Laboratory <span class="sort">⇅</span></th>
          <th>Login <span class="sort">⇅</span></th>
          <th>Logout <span class="sort">⇅</span></th>
          <th>Date <span class="sort">⇅</span></th>
          <th>Action <span class="sort">⇅</span></th>
        </tr>
      </thead>
      <tbody>
